            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <x-nav-link href="{{ route('articles.index') }}" :active="request()->is(route('articles.index'))">Artikel</x-nav-link>
                        <x-nav-link href="/latihan" :active="request()->is('latihan')">Latihan</x-nav-link>
